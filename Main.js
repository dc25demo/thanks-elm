...
var _user$project$Msg$GazersFetched = function (a) {
	return {ctor: 'GazersFetched', _0: a};
};
...
var _user$project$Model$Model = F2(
	function (a, b) {
		return {dependencies: a, gazers: b};
	});
								...
								A2(
										...
										_p0._0),
									{
										...
										_0: A2(
											_elm_lang$html$Html$div,
											{ctor: '[]'},
											A2(_elm_lang$core$List$map, _elm_lang$html$Html$text, model.gazers)),
										_1: {ctor: '[]'}
									})),
							_1: {
								ctor: '::',
...
var _user$project$Main$getGazersCmd = function (reponame) {
	var decodeGazers = _elm_lang$core$Json_Decode$list(
		A2(_elm_lang$core$Json_Decode$field, 'login', _elm_lang$core$Json_Decode$string));
	var url = A2(
		_elm_lang$core$Basics_ops['++'],
		'https://api.github.com/repos/',
		A2(_elm_lang$core$Basics_ops['++'], reponame, '/stargazers'));
	var request = A2(_elm_lang$http$Http$get, url, decodeGazers);
	return A2(_elm_lang$http$Http$send, _user$project$Msg$GazersFetched, request);
};
					...
					_1: function () {
						...
						if (_p1.ctor === 'Err') {
							...
							if (_p1._0.ctor === '[]') {
								...
								return _user$project$Main$getGazersCmd('dc25/solitaire');
							}
						}
					}()
				};
...
var _user$project$Main$init = {
	...
	_0: A2(
		...
		_elm_lang$core$Result$Ok(
			{ctor: '[]'}),
		{ctor: '[]'}),
	_1: _user$project$Main$getGazersCmd('dc25/solitaire')
};
