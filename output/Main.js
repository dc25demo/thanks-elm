...
var _user$project$Main$setError = F2(
	function (model, err) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				projectData: _elm_lang$core$Maybe$Just(
	...
	var tokenRequest = _elm_lang$http$Http$request(
		{
			...
			url: A2(_elm_lang$core$Basics_ops['++'], corsAnywhere, 'https://github.com/login/oauth/access_token/'),
			body: A2(_elm_lang$http$Http$stringBody, 'application/x-www-form-urlencoded', content),
